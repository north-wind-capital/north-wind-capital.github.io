...
A small SVG compass follows section landmarks and rotates its needle with scroll distance. Desktop positioning checks text and control bounds before choosing an open position. Phones reserve a narrow right gutter. The guide cannot intercept pointer input, is decorative to assistive technology, and parks when motion is disabled.
